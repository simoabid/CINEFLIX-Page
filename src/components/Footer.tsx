        ...
        <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-12 gap-10 md:gap-8 mb-16">
          ...
          <div className="col-span-1 sm:col-span-1 md:col-span-2 lg:col-span-2">
            ...
            <ul className="space-y-2 text-xs sm:text-sm text-gray-400">
              <li>
                <a href="#features" className="hover:text-accent-red transition-colors flex items-center gap-1.5 interactive-target">
              ...
              <li>
                <a href="#how-it-works" className="hover:text-accent-red transition-colors flex items-center gap-1.5 interactive-target">
                  <svg className="w-3.5 h-3.5 shrink-0" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth="2">
              ...
              <li>
                <a href="#content" className="hover:text-accent-red transition-colors flex items-center gap-1.5 interactive-target">
                  <svg className="w-3.5 h-3.5 shrink-0" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth="2">
              ...
              <li>
                <a href="#faq" className="hover:text-accent-red transition-colors flex items-center gap-1.5 interactive-target">
                  <svg className="w-3.5 h-3.5 shrink-0" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth="2">
